...
export default function LoginScreen({ navigation }: any) {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <KeyboardAvoidingView
        // FIX 1: Use 'padding' for iOS, but undefined for Android to prevent "twitching"
        behavior={Platform.OS === "ios" ? "padding" : undefined}
        style={{ flex: 1 }}
      >
        {/* FIX 2: Use ScrollView to handle layout changes smoothly */}
        <ScrollView 
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  // UPDATED: Move layout logic to scrollContent
  scrollContent: {
    flexGrow: 1,
