...
export default function DashboardScreen() {
  const [activeTab, setActiveTab] = useState<"PENDING" | "PREPARING">(
    "PENDING"
  );
  ...
  return (
    <View style={styles.container}>
      {/* New Header */}
      <Header title="Order Command" subtitle="ChowEasy Vendor" />
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text
            style={[
              styles.tabText,
              activeTab === "PREPARING" && styles.activeTabText,
            ]}
          >
            In Kitchen
          </Text>
